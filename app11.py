...
class App(threading.Thread):
    ...
    def AddWidgets(self):
        ...
        self.txt_porta_selecionada_opt = tk.Label(self.janela, text='Porta Selecionada: ', background='white', font='Arial 8 bold')
        ...
        self.txt_status_servidor1 = tk.Label(self.janela, text='Status Servidor: ', background='white', font='Arial 8 bold')
        self.txt_status_servidor1.place(x=45, y=300)

        self.txt_status_servidor2 = tk.Label(self.janela, text='Offline', background='red', font='Arial 8 bold')
        self.txt_status_servidor2.place(x=180, y=300)

        #BUTTONS
        self.ObterValor = Button(self.janela, text='Obter Peso', width=9, height=1, bd=5, relief='flat', background='#cdad00', state = DISABLED,
                                 activebackground='#8b7500', activeforeground='#8b7500', foreground='#000', command=self.Obter)
        self.ObterValor.place(x=45, y=200)
        ...
        self.gerarNumero.place(x=45, y=150)
    ...
    def Obter(self):
        ...
        self.ObterValor['state'] = 'disabled'
    ...
    def geraNumero(self):
        ...
        if self.txt_label_numero_barra['text'] == result:
            self.ObterValor['state'] = 'normal'

        self.gerarNumero['state'] = 'disabled'

    def atualizaStatus(self):
        while True:
            ws2 = create_connection("ws://localhost:1880/ws/statusCom")
            res = (ws2.recv())
            print(res)
            ws2.close()
            sleep(5)
            ...
            if res == 'true':
                self.txt_status_servidor2['text'] = 'Online'
                self.txt_status_servidor2['background'] = 'green'
            elif res == 'false':
                self.txt_status_servidor2['text'] = 'Offline'
                self.txt_status_servidor2['background'] = 'red'
